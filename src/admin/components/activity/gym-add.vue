<template>
	<div class="gym-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '德育活动', '体艺活动', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.gym-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.gym-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.gym-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
