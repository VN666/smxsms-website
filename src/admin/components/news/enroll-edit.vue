	...
	data () {
		return {
			...
			addForm: {
				...
				department: "三门峡市二中",
				author: "",
				ppublisher: localStorage.getItem("username"),
				timecreate: "",
				isTop: "",
				content: "",
				picSrc: [],
...
<style>
	.enroll-edit .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.enroll-edit .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.enroll-edit .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
