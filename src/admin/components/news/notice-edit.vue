...
<style>
	.notice-edit .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.notice-edit .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.notice-edit .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
