<template>
	<div class="staff-edit">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '职工之家', '编辑']"></h-breadcrumb>
		</div>
...
<style>
	.staff-edit .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.staff-edit .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.staff-edit .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
