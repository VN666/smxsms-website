<template>
	<div class="ccyl-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '团建活动', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.ccyl-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.ccyl-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.ccyl-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
