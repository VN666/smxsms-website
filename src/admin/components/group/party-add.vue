...
<style>
	.party-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.party-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.party-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
