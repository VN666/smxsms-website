<template>
	<div class="theory-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '学校党建', '理论学习', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.theory-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.theory-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.theory-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
