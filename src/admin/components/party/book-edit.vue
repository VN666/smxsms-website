...
export default {
	...
	methods: {
		...
		requestData (id) {
			this.$http({
				method: "post",
				url: this.$api.party_book_queryById,
...
<style>
	.book-edit .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.book-edit .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.book-edit .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
