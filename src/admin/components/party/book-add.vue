<template>
	<div class="book-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '学校党建', '台账管理', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.book-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.book-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.book-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
