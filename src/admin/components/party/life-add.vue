<template>
	<div class="life-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '二中党建', '组织生活', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.life-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.life-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.life-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
