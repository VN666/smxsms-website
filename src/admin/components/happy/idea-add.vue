<template>
	<div class="idea-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '幸福教育', '幸福理念', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.idea-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.idea-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.idea-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
