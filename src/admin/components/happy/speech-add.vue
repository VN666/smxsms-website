<template>
	<div class="speech-add">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '幸福教育', '幸福感言', '新增']"></h-breadcrumb>
		</div>
...
<style>
	.speech-add .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.speech-add .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.speech-add .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
