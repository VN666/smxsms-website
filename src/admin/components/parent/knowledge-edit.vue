<template>
	<div class="knowledge-edit">
		<div class="breadcrumb_wrap" ref="breadcrumb_wrap">
			<h-breadcrumb :bread="['后台管理', '家长学校', '家教知识', '编辑']"></h-breadcrumb>
		</div>
...
<style>
	.knowledge-edit .file-upload .el-upload-list {
		display: flex;
		flex-direction: row;
		justify-content: flex-start;
		flex-wrap: wrap;
	...
	.knowledge-edit .file-upload .el-upload-list li {
		margin-right: 8px;
		width: 200px;
		background: #F5F7FA;
	}
	.knowledge-edit .file-upload .el-upload-list li:first-child {
		margin-top: 0px;
	}
</style>
