	...
	methods: {
		requestData () {
			this.$http({
				...
				let html = `<img src="${this.content.headSrc}" style="float: left;width: 360px;height: 270px; margin-right: 16px;"/>`
				this.content.content = html + this.content.content;
			})
		}
	}
}
